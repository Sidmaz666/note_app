-- ============================================
-- CONSOLIDATED MIGRATION: Color + Sort Order
-- ============================================
-- Run this if you've already run the base supabase.sql
-- This adds color and sort_order columns and updates functions
...
-- ============================================
-- 3. UPDATE search_notes FUNCTION
-- ============================================
...
-- ============================================
-- 4. UPDATE sync_note FUNCTION
-- ============================================
DROP FUNCTION IF EXISTS public.sync_note(text, uuid, text, text, text, timestamp with time zone) CASCADE;
DROP FUNCTION IF EXISTS public.sync_note(text, uuid, text, text, text, integer, timestamp with time zone) CASCADE;
